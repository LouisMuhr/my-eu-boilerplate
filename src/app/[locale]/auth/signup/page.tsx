        ...
        <div className="relative group">
          ...
          <div className="relative bg-white/90 dark:bg-slate-900/90 backdrop-blur-2xl rounded-3xl border-2 border-slate-200/50 dark:border-slate-800/50 shadow-2xl p-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="relative group/input">
                  <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-slate-400 group-focus-within/input:text-indigo-600 transition-colors" />
                  <input
                    type="text"
                    required
                    value={name}
              ...
              <div className="pt-2">
                <p className="text-[11px] text-slate-500 dark:text-slate-400 leading-relaxed text-center px-2">
                  ...
                  <Link
                    href="/legal/privacy"
                    className="text-indigo-600 hover:text-indigo-700 dark:hover:text-indigo-500 font-bold transition-colors"
                  >
                    {t("privacy_policy")}
                  </Link>{" "}
                  &{" "}
            ...
            <p className="mt-8 text-center text-sm text-slate-600 dark:text-slate-400">
              ...
              <Link
                href="/auth/signin"
                className="font-black text-indigo-600 hover:text-indigo-700 dark:hover:text-indigo-500 transition-colors"
              >
                {t("login_now")}
              </Link>
            </p>
