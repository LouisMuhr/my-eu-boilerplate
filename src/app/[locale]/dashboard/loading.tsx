    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-indigo-50/30 dark:from-slate-950 dark:via-slate-900 dark:to-indigo-950/20 flex flex-col md:flex-row font-sans relative overflow-hidden">
      ...
      <main className="flex-1 flex flex-col min-w-0 relative">
        ...
        <header className="h-24 border-b border-slate-200/50 dark:border-slate-800/50 bg-white/60 dark:bg-slate-900/60 backdrop-blur-2xl flex items-center px-8 justify-between sticky top-0 z-30">
          ...
          <div className="h-11 w-11 bg-slate-200 dark:bg-slate-700 rounded-2xl animate-pulse"></div>
        </header>

        {/* Main Content Skeleton */}
        <div className="p-6 md:p-12 max-w-7xl mx-auto w-full space-y-10">
          {/* Welcome Section Skeleton */}
          <div className="relative p-8 rounded-3xl bg-white/50 dark:bg-slate-900/50 backdrop-blur-xl border border-slate-200/50 dark:border-slate-800/50">
            <div className="h-10 w-64 bg-slate-200 dark:bg-slate-700 rounded-lg animate-pulse mb-4"></div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {[1, 2, 3].map((i) => (
              <div key={i} className="bg-white dark:bg-slate-900 p-8 rounded-3xl border-2 border-slate-200 dark:border-slate-800">
          ...
          <div className="bg-white/60 dark:bg-slate-900/60 backdrop-blur-xl rounded-[3rem] border border-slate-200/50 dark:border-slate-800/50 p-8 space-y-6">
            <div className="h-8 w-48 bg-slate-200 dark:bg-slate-700 rounded-lg animate-pulse mb-6"></div>

            {/* Billing Cards Skeleton */}
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {[1, 2].map((i) => (
                <div key={i} className="bg-white dark:bg-slate-900 rounded-3xl p-6 border-2 border-slate-200 dark:border-slate-800">
                  <div className="h-6 w-32 bg-slate-200 dark:bg-slate-700 rounded-lg animate-pulse mb-4"></div>
                  <div className="h-12 w-48 bg-slate-200 dark:bg-slate-700 rounded-lg animate-pulse mb-4"></div>
